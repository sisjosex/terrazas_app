...
iScroll.prototype = {
	...
	touchStart: function(e) {
		...
		if($(e.target).hasClass('button') /*|| $(e.target).is('input') || $(e.target).is('textarea')*/ /*|| !$(e.target).hasClass('list-item')*/ ) {
			//e.stopPropagation();
			//e.preventDefault();
			return;
		...
		// This is probably not needed, but may be useful if iScroll is used in conjuction with other frameworks
